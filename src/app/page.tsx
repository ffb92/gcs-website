  ...
  return (
    <div className="min-h-screen bg-[var(--color-surface)]">
          ...
          <div className="flex items-center gap-6">
            {['Philosophie', 'Produktion', 'Qualität', 'Partner'].map((item) => (
              <a
                ...
                className="text-sm text-[var(--color-text-secondary)] hover:text-white transition-colors hidden md:block"
              >
                {item}
              </a>
            ))}
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden gradient-hero">
        <div className="absolute top-1/4 left-1/4 w-[600px] h-[600px] rounded-full gradient-solar-glow blur-3xl opacity-30" />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full gradient-green-glow blur-3xl opacity-20" />
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="animate-fade-up animate-fade-up-delay-1 text-5xl sm:text-6xl lg:text-7xl font-light tracking-tight leading-tight mb-6">
            <span className="text-white">Medical Cannabis.</span>
            <br />
            <span className="text-white">Made in Germany.</span>
            <br />
          ...
          <p className="animate-fade-up animate-fade-up-delay-2 text-lg sm:text-xl text-[var(--color-text-secondary)] max-w-2xl mx-auto mb-10 font-light leading-relaxed">
            GCS produziert medizinisches Cannabis in einer der modernsten
            GMP-zertifizierten Anlagen Europas — im Solar Valley Bitterfeld.
            Nachhaltig, kontrolliert, skalierbar.
          </p>

          <div className="animate-fade-up animate-fade-up-delay-3 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="#produktion"
              className="px-8 py-4 rounded-full bg-gradient-to-r from-solar-500 to-ember-500 text-black font-semibold hover:shadow-lg hover:shadow-solar-500/20 transition-all active:scale-95"
            >
              Produktion entdecken
            </a>
            <a
              href="#kontakt"
              className="px-8 py-4 rounded-full border border-[var(--color-border-hover)] text-[var(--color-text-secondary)] hover:text-white hover:border-white/20 transition-all"
            >
              Partner werden
            </a>
          </div>
          ...
          <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto">
            {[
              ...
              <div key={stat.label} className="text-center">
                ...
                <div className="text-xs text-[var(--color-text-muted)] tracking-wide uppercase">
                  {stat.label}
                </div>
              </div>
            ))}
      ...
      <section id="philosophie" className="py-32 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-20">
            <span className="text-xs tracking-widest uppercase text-solar-400 mb-4 block">
              Unsere Mission
            </span>
            <h2 className="text-3xl sm:text-4xl font-light text-white mb-6">
              From Cultivation to Pharmacies.
              <br />
              <span className="text-[var(--color-text-secondary)]">Made in Germany. Solar-betrieben.</span>
            </h2>
            <p className="text-[var(--color-text-secondary)] max-w-2xl mx-auto leading-relaxed font-light">
              Wir kultivieren medizinisches Cannabis auf 20.000 m² im Solar Valley
              Bitterfeld — mit 100% erneuerbarer Energie. Als vollintegriertes Unternehmen
              kontrollieren wir die gesamte Wertschöpfungskette: vom Anbau über die
              GMP-zertifizierte Produktion bis zur Distribution an Apotheken.
            </p>
          </div>
            ...
            {[
              {
                icon: '☀️',
                title: 'Solar Power',
                text: 'Unsere Anlage wird vollständig mit Solarenergie betrieben. Das senkt nicht nur CO₂-Emissionen, sondern garantiert auch stabile Energiepreise für eine skalierbare Produktion.',
              },
              {
                icon: '🧬',
                title: 'GMP & GACP',
                text: 'Zertifiziert nach höchsten pharmazeutischen Standards. Jede Charge wird unter Reinraumbedingungen produziert und durchläuft strenge Qualitätskontrollen.',
              },
              {
                icon: '🔗',
                title: 'Full Vertical',
                text: 'Vom Seed bis zur Apotheke — wir besitzen und kontrollieren jeden Schritt. Das bedeutet volle Transparenz, konstante Qualität und zuverlässige Lieferketten.',
              },
            ].map((pillar) => (
              <div
                key={pillar.title}
                className="group p-8 rounded-3xl gradient-card border border-[var(--color-border)] hover:border-[var(--color-border-hover)] transition-all duration-300"
              >
      ...
      <section id="produktion" className="py-32 px-6 gradient-solar relative overflow-hidden">
        <div className="absolute inset-0 opacity-30" style={{
          backgroundImage: "url('data:image/svg+xml,%3Csvg width=%2260%22 height=%2260%22 xmlns=%22http://www.w3.org/2000/svg%22%3E%3Cpath d=%22M36 18c0-1.3-1.1-2.4-2.4-2.4H15.6c-1.3 0-2.4 1.1-2.4 2.4v7.2c0 1.3 1.1 2.4 2.4 2.4h18c1.3 0 2.4-1.1 2.4-2.4v-7.2z%22 fill=%22%23fff%22 fill-opacity=%22.02%22/%3E%3C/svg%3E')"
        }} />
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-white/60 max-w-2xl mx-auto leading-relaxed font-light">
              Im Herzen des Solar Valley entsteht eine der modernsten Cannabis-Produktionsanlagen Deutschlands.
              Auf 20.000 m² produzieren wir jährlich bis zu 25 Tonnen medizinisches Cannabis — vollständig mit erneuerbarer Energie.
            </p>
          </div>
            ...
            <div className="space-y-8">
              {[
                ...
                <div key={item.num} className="flex gap-5">
                  <div className="text-2xl font-light text-solar-400/60 tabular-nums shrink-0">{item.num}</div>
                  <div>
            ...
            <div className="relative aspect-square rounded-3xl gradient-card border border-[var(--color-border)] overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="text-white/40 text-sm font-mono">Bitterfeld-Wolfen</div>
                  <div className="text-white/20 text-xs mt-2">Solar Valley</div>
                  <div className="mt-8 grid grid-cols-3 gap-3 px-8">
                    {['GMP', 'GACP', 'EU-GMP'].map((cert) => (
                      <div key={cert} className="px-3 py-2 rounded-lg bg-white/5 border border-white/5 text-xs text-white/40 text-center">{cert}</div>
                    ))}
                  </div>
                </div>
              </div>
              <div className="absolute inset-0 opacity-5">
                {Array.from({ length: 8 }).map((_, i) => (
                  <div key={i} className="border-t border-solar-400" style={{ marginTop: `${(i + 1) * 12.5}%` }} />
                ))}
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {[
              ...
              <div key={card.title} className="p-6 rounded-2xl gradient-card border border-[var(--color-border)] text-left">
                ...
                <ul className="space-y-2">
                  {card.items.map((item) => (
                    <li key={item} className="flex items-start gap-3 text-sm text-[var(--color-text-secondary)]">
                      <span className="text-gcs-green-400 mt-0.5 shrink-0">✓</span>
                      {item}
                    </li>
                  ))}
                </ul>
      ...
      <section id="partner" className="py-32 px-6 gradient-solar relative">
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            {[
              { name: 'Humboldt-Universität Berlin', role: 'Wissenschaftlicher Partner', desc: 'Forschung zu urbaner Pflanzenökophysiologie. Prof. Dr. Christian Ulrichs leitet die Forschungsaktivitäten.', icon: '🎓' },
              { name: 'K+S Gruppe', role: 'Industriepartner', desc: 'Einer der weltweit führenden Bergbau- und Rohstoffkonzerne. Strategische Partnerschaft für Infrastruktur.', icon: '⛏️' },
              { name: 'Solar Valley Bitterfeld', role: 'Energiepartner', desc: 'Direkter Zugang zu 100% erneuerbarer Energie. Null CO₂-Emissionen im Betrieb.', icon: '☀️' },
            ].map((partner) => (
              <div key={partner.name} className="p-8 rounded-2xl gradient-card border border-white/5 hover:border-white/10 transition-all">
                <div className="text-3xl mb-4">{partner.icon}</div>
                <h3 className="text-white font-medium mb-2">{partner.name}</h3>
                <div className="text-xs text-solar-400 mb-3">{partner.role}</div>
                <p className="text-sm text-white/40 font-light leading-relaxed">{partner.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="kontakt" className="py-32 px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-[var(--color-text-secondary)] mb-12 leading-relaxed font-light">
            Sie sind Apotheker, Investor oder Partner aus der Pharmabranche? Wir freuen uns auf den Austausch.
          </p>
      ...
      <footer className="py-12 px-6 border-t border-[var(--color-border)]">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="text-xs text-[var(--color-text-muted)]">
            Medical Cannabis. Made in Germany. Fueled by Solar Power.
          </div>
        </div>
      </footer>
    </div>
